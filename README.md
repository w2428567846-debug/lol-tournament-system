...
- 管理员可按每届赛事设置选手虚拟费用、战队归属、胜负、K/D/A 与最终名次
- `/players` 公开花名册汇总公开赛事中的段位、位置、费用与历届表现，私人赛事名单不会进入汇总
...
队伍报名、混合报名、自动分队、自动赛程、积分计算、比赛结果自动采集、淘汰赛晋级、账号绑定、BP 与实时比赛数据均不在当前范围内。当前选手赛事数据由管理员手动维护。
